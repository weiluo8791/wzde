...
class elFinder {
	...
	public function __construct($opts) {
		...
		// CWT-8853 - issue #5 and issue #6 define path to 7z.exe (custome change)
		! defined('ELFINDER_7Z_PATH')       && define('ELFINDER_7Z_PATH', (substr(PHP_OS, 0, 3) === 'WIN')? $_SERVER["APPL_PHYSICAL_PATH"].'tools\7z.exe' : '7za');
