...
abstract class elFinderVolumeDriver {
	...
	public function removed() {
		if ($this->removed) {
			...
			// patch for https://github.com/Studio-42/elFinder/issues/2641
			// https://github.com/Studio-42/elFinder/commit/bdab8ea481d835d95d33e1b9a70546e9cdb9de3b
			// ATWEB-8509 - Patch fix from elfinder bug
	...
	protected static function localRmdirRecursive($dir) {
		...
		if (is_callable('exec')) {
			...
			if (substr(PHP_OS, 0, 3) === 'WIN') {
				// Patch for https://github.com/Studio-42/elFinder/issues/2791
				// https://github.com/Studio-42/elFinder/commit/1704b62d9f192a39bb1f351642575bc53ce9b8d9
				// Part of the update for CWT-8508 - WZDE Manage update (ELFinder 2.19 - > 2.37)
				// Discovered by testing from CWT-8826 				
